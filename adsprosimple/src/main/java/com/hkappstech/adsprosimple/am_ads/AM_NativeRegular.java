...
public class AM_NativeRegular {

    static NativeAd mPack1NativeAdsRegular = null;

    public static void showNativeAdsBigMain(FrameLayout fl_adplaceholder, ShimmerFrameLayout shimmerFrameLayout, Activity activity) {
    ...
    public static void loadAdmobNativeAdBig(FrameLayout fl_adplaceholder, ShimmerFrameLayout shimmerFrameLayout, Activity activity) {
    ...
    public static void showNativeOptionAdBig(FrameLayout fl_adplaceholder, Activity activity) {
        try {
...
//                Log.e(Pack1AdManager.PACK1_ADMOB_TAG, "Native Ads Big ==> Success to show")
            } else {
                fl_adplaceholder.setVisibility(View.GONE);
//                Log.e(Pack1AdManager.PACK1_ADMOB_TAG, "Native Ads Big ==> null")
            }
        } catch (Exception e) {
            e.printStackTrace();
            fl_adplaceholder.setVisibility(View.GONE);
