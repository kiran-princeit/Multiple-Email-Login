...
public class AM_NativeSmall {
    ...
    public static void showNativeAdsSmallMain(FrameLayout fl_adplaceholder, ShimmerFrameLayout shimmerFrameLayout, Activity activity) {
    ...
    public static void showNativeOptionAdSmall(FrameLayout fl_adplaceholder, Activity activity) {
        try {
